...
export const VapiConnectedView = ({ onDisconnect }: VapiConnectedViewProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="overflow-hidden rounded-lg bg-primary-foreground py-0">
        <Tabs
          className="gap-0 bg-primary-foreground"
          defaultValue="phone-numbers"
          onValueChange={setActiveTab}
          value={activeTab}
        >
          <TabsList className="grid h-12 w-full grid-cols-2 p-0 bg-primary-foreground">
            <TabsTrigger
              value="phone-numbers"
